      ...
      <Container fluid="md" className="padding-top-first-section">
        <Row>
          ...
          <p>
            ...
            como lidamos com dados do usuário e informações pessoais, entre em contacto connosco.
          </p>
          <h3 className="fw-bold">Política de Cookies As Raparigas do Código</h3>
          <h5 className="fw-bold">O que são cookies?</h5>
          <p>
          ...
          <h5 className="fw-bold">Como usamos os cookies?</h5>
          <p>
          ...
          <h5 className="fw-bold">Desativar cookies</h5>
          <p>
          ...
          <h5 className="fw-bold"> Cookies que definimos</h5>
          <ul >
            <li>
              <p className="h5 fs-5">1. Cookies relacionados à conta</p>
            </li>
            <li>
              <p>Se você criar uma conta connosco, usaremos cookies para o gerenciamento do processo de
          ...
          <li><p className="h5 fs-5">2. Cookies relacionados ao login</p></li>
          <li><p>
          ...
          <li>
            <p className="h5 fs-5">3. Cookies relacionados a boletins por e-mail</p>
          </li>
          <li>
            <p>
              Este site oferece serviços de assinatura de boletim informativo ou e-mail e os cookies
              podem ser usados paralembrar se você já está registrado e se deve mostrar determinadas
              notificações válidas apenas para usuários inscritos / não inscritos.
            </p>
          </li>
          <li><p className="h5 fs-5">4. Pedidos processando cookies relacionados</p></li>
          <li>
            <p>
          ...
          <li><p className="h5 fs-5">5. Cookies relacionados a pesquisas</p></li>
          <li>
            <p>
          ...
          <li><p className="h5 fs-5">6. Cookies relacionados a formulários</p></li>
          <li>
            <p>
          ...
          <li><p className="h5 fs-5">7. Cookies de preferências do site</p></li>
          <li>
            <p>
          ...
          <p>
            ...
            Google Analytics.As análises de terceiros são usadas para rastrear e medir o uso deste
            site, para que possamos continuar produzindo conteúdo atrativo. Esses cookies podem
            rastrear itens como o tempo que você passa no site ou as páginas visitadas, o que nos
            ajuda a entender como podemos melhorar o site para você.
          </p>
          <p>
            Periodicamente, testamos novos recursos e fazemos alterações subtis na maneira como o
          ...
          <p>
            O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o As
          ...
          pública; B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, apostas
          online ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra
          os direitos humanos; C) Não causar danos aos sistemas físicos (hardwares) e lógicos
          (softwares) do As Raparigas do Código, de seus fornecedores ou terceiros, para introduzir
          ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que
          sejam capazes de causar danos anteriormente mencionados. Mais informações
          <p>
          ...
          <p>Esta política é efetiva a partir de 15 agosto 2022 15:13</p>
        </Row>
      </Container>
    </PageLayout>
  );
