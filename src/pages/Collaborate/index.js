...
const Collaborate = () => (
  <Container fluid="md" className="Collaborate">
    ...
    <NumberedRow number='02' title='Escrever textos originais sobre temas relacionados com Ciência e Tecnologia' textHtml='<p>Podem ser artigos de opinião, críticas, recomendações, crónicas ou notícias. Podes escrever para a nossa rubrica “MulherTech”, ou qualquer outro tema tecnológico que te entusiasme. Se também és versado/a em linguagens de programação, podes escrever um tutorial sobre desenvolvimento web, aplicações android ou data science, por exemplo. <strong>Porque não?</strong></p>'/>
    <NumberedRow number='03' title='Realização e Organização de Talks e Workshops' textHtml='<p>Se no trabalho não te deixam explicar como resolveste aquele bug, ou ninguém te quer ouvir a falar de automação de testes ao almoço, nós queremos! Podes por exemplo voluntariar-te para dar um workshop ou uma talk sobre um tema à tua escolha. Podes também partilhar a tua experiência no mundo da Tecnologia e inspirar as nossas alunas, <strong>ser um/a role model!</strong></p>'/>
    <NumberedRow number='04' title='Realização de Eventos' textHtml='<p>Caso tenhas experiência na realização de eventos, gostaríamos de contar com a tua ajuda para a criação de hackatons, webinars, encontros e outras oportunidades de networking. Se achas que a tua empresa gostava de nos receber para uma visita guiada ao mundo tech, entra em contacto connosco!</p>'/>
    <NumberedRow number='05' title='Mentoria & Educação' textHtml='<p>Se não gostas de falar em público, mas és secretamente um/a ninja do código, podes ajudar alguém a ultrapassar os obstáculos que surgem nos primeiros passos da aprendizagem da programação. Ajudar alguma das nossas alunas a compreender um problema, a resolver um bug, a explicar um conceito ou até incentivá-la a melhorar as suas capacidades com desafios extra. Torna-te um/a mentor/a!</p><p>Se gostas de ensinar, podes colaborar na realização dos nossos workshops através da criação de material ou acompanhamento de aulas, criação de exercícios, projetos ou desafios extra.</p>'/>
    <NumberedRow number='06' title='Colaboração Técnica' textHtml='<p>Se preferires, podes ajudar-nos na manutenção do website ou no apoio técnico às alunas (instalação de software, troubleshooting).</p>'/>
